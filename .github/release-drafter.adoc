...
Have a look to the sample configuration available in the link:https://github.com/jenkinsci/archetypes/blob/master/common-files/.github/workflows/release-drafter.yml[Maven archetype].
